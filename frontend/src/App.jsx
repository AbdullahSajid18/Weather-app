...
function WeatherApp() {
  ...
  const getWeather = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_APP_BACKEND_URL}/weather`,
        { city: city },
        {
      ...
      const historyResponse = await axios.get(
        `${import.meta.env.VITE_REACT_APP_BACKEND_URL}/weather/${city}`
      );
      const history = historyResponse.data;
      setWeatherHistory(history);

      setCity(""); // Clearing the input after the data is fetched
    } catch (err) {
  ...
  // Getting Weather Emoji based on the weather conditions
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
              ...
              {weatherHistory.map((weather, index) => (
                <div
                  ...
                  style={{
                    ...
                    border:
                      index === 0 ? "2px solid #00b894" : "1px solid #e9ecef",
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div
                        style={{
                          color:
                            index === 0 ? "rgba(255,255,255,0.9)" : "#636e72",
                          fontSize: "0.9rem",
                        }}
                      >
        ...
        {!currentWeather && !error && !loading && (
          ...
          >
            ...
            >
              Enter any city name above to get real-time weather information and
